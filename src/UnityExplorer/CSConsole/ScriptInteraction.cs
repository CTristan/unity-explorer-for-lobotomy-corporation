...
namespace UnityExplorerForLobotomyCorporation.UnityExplorer.CSConsole
{
    public class ScriptInteraction : InteractiveBase
    {
        ...
        {
            return RuntimeHelper.StartCoroutine(ienumerator);
        }
        ...
        {
            if (AccessTools.Field(typeof(Evaluator), "source_file").GetValue(Evaluator) is CompilationSourceFile sourceFile && sourceFile.Containers.Any())
            {
