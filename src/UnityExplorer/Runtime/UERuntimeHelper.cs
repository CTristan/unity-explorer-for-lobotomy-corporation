...
namespace UnityExplorerForLobotomyCorporation.UnityExplorer.Runtime
{
    ...
    public abstract class UERuntimeHelper
    {
        ...
        public virtual string[] DefaultReflectionBlacklist =>
            new string[0];
        ...
        public static void Init()
        {
            ...
            ConfigManager.Reflection_Signature_Blacklist.OnValueChanged += val =>
            {
        ...
        public static void LoadBlacklistString(string blacklist)
        {
            try
            {
                ...
                Blacklist.SignatureBlacklist = currentBlacklist;
            }
            catch (Exception ex)
            {
