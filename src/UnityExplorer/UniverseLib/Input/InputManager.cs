...
{
    /// <summary>A universal Input handler which works with both legacy Input and the new InputSystem.</summary>
    public static class InputManager
    {
        ...
        /// <summary>The current Input package which is being used by the game.</summary>
        public static InputType CurrentType { get; private set; }

        // ~~~~~~ Main Input API ~~~~~~

        /// <summary>The current user Cursor position, with (0,0) being the bottom-left of the game display window.</summary>
        ...
        /// <summary>The current mouse scroll delta from this frame. x is horizontal, y is vertical.</summary>
        ...
        /// <summary>Whether anything is currently using the Rebinding feature. If no UI is showing, this will return false.</summary>
        public static bool Rebinding
        {
            get =>
                isRebinding && UniversalUI.AnyUIShowing;
            set =>
                isRebinding = value;
        }

        /// <summary>The last pressed Key during rebinding.</summary>
        public static KeyCode? LastRebindKey { get; set; }

        /// <summary>Returns true if the provided KeyCode was pressed this frame. Translates KeyCodes into Key if InputSystem is being used.</summary>
        ...
        /// <summary>Returns true if the provided KeyCode is being held down (not necessarily just pressed). Translates KeyCodes into Key if InputSystem is being used.</summary>
        ...
        /// <summary>Returns true if the provided KeyCode was released this frame. Translates KeyCodes into Key if InputSystem is being used.</summary>
        ...
        /// <summary>Returns true if the provided mouse button was pressed this frame. <br />0 = left, 1 = right, 2 = middle, 3 = back, 4 = forward.</summary>
        ...
        /// <summary>Returns true if the provided mouse button is being held down (not necessarily just pressed). <br />0 = left, 1 = right, 2 = middle, 3 = back, 4 = forward.</summary>
        ...
        /// <summary>Returns true if the provided mouse button was released this frame. <br />0 = left, 1 = right, 2 = middle, 3 = back, 4 = forward.</summary>
        ...
        /// <summary>Calls the equivalent method for the current <see cref="InputType" /> to reset the Input axes.</summary>
        ...
        /// <summary>Begins the Rebinding process, keys pressed will be recorded. Call <see cref="EndRebind" /> to finish rebinding.</summary>
        ...
        public static void BeginRebind(Action<KeyCode> onSelection,
            Action<KeyCode?> onFinished)
        {
            if (Rebinding)
            {
                return;
        ...
        /// <summary>Call this to finish Rebinding. The onFinished Action supplied to <see cref="BeginRebind" /> will be invoked if we are currently Rebinding.</summary>
