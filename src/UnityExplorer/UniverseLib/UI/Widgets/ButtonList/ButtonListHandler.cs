...
{
    /// <summary>A helper to create and handle a simple <see cref="ScrollPool{T}" /> of Buttons, which can be backed by any data.</summary>
    public class ButtonListHandler<TData, TCell> : ICellPoolDataSource<TCell> where TCell : ButtonCell
    {
        ...
        public ButtonListHandler(ScrollPool<TCell> scrollPool,
            Func<List<TData>> getEntriesMethod,
        ...
        public virtual void SetCell(TCell cell,
            int index)
        {
