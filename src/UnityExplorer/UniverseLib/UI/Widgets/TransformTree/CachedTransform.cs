...
namespace UnityExplorerForLobotomyCorporation.UniverseLib.UI.Widgets.TransformTree
{
    ...
    {
        public CachedTransform(TransformTree tree,
            Transform transform,
            int depth,
        ...
        public bool Expanded =>
            Tree.IsTransformExpanded(InstanceID);
            ...
            int depth)
        {
            ...
            if (!Value.ReferenceEqual(transform) || depth != Depth || ChildCount != transform.childCount || Name != transform.name || Enabled != transform.gameObject.activeSelf ||
