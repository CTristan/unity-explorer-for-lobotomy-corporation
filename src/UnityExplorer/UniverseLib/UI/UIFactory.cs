...
{
    /// <summary>Helper class to create Unity uGUI UI objects at runtime, as well as use some custom UniverseLib UI classes such as ScrollPool, InputFieldScroller and AutoSliderScrollbar.</summary>
    public static class UIFactory
    {
        internal static Vector2 largeElementSize = new Vector2(100, 30);
        internal static Vector2 smallElementSize = new Vector2(25, 25);
        internal static Color defaultTextColor = Color.white;

        /// <summary>Create a simple UI object with a RectTransform. <paramref name="parent" /> can be null.</summary>
        ...
        internal static void SetDefaultSelectableValues(Selectable selectable)
        {
            ...
            RuntimeHelper.Instance.Internal_SetColorBlock(selectable, new Color(0.2f, 0.2f, 0.2f), new Color(0.3f, 0.3f, 0.3f), new Color(0.15f, 0.15f, 0.15f));
        }


        #region Layout Helpers

        /// <summary>Get and/or Add a LayoutElement component to the GameObject, and set any of the values on it.</summary>
        public static LayoutElement SetLayoutElement(GameObject gameObject,
            int? minWidth = null,
            int? minHeight = null,
        ...
        /// <summary>Get and/or Add a HorizontalOrVerticalLayoutGroup (must pick one) to the GameObject, and set the values on it.</summary>
        public static T SetLayoutGroup<T>(GameObject gameObject,
            ...
            int? padLeft = null,
            int? padRight = null,
            TextAnchor? childAlignment = null) where T : HorizontalOrVerticalLayoutGroup
        {
        ...
        /// <summary>Set the values on a HorizontalOrVerticalLayoutGroup.</summary>
        public static T SetLayoutGroup<T>(T group,
            bool? forceWidth = null,
            bool? forceHeight = null,
            bool? childControlWidth = null,
            bool? childControlHeight = null,
        ...
        /// <summary>Create a simple UI Object with a VerticalLayoutGroup and an Image component. <br /><br />See also: <see cref="PanelBase" /></summary>
            ...
            Color? bgColor = null)
        {
            ...
            var bgImage = contentHolder.AddComponent<Image>();
            bgImage.type = Image.Type.Filled;
            bgImage.color = bgColor == null ? new Color(0.07f, 0.07f, 0.07f) : (Color)bgColor;
        ...
        /// <summary>Create a VerticalLayoutGroup object with an Image component. Use SetLayoutGroup to create one without an image.</summary>
        public static GameObject CreateVerticalGroup(GameObject parent,
            string name,
            bool forceWidth,
            bool forceHeight,
            ...
            TextAnchor? childAlignment = null)
        {
            ...
            SetLayoutGroup<VerticalLayoutGroup>(groupObj, forceWidth, forceHeight, childControlWidth, childControlHeight, spacing, (int)padding.x, (int)padding.y, (int)padding.z, (int)padding.w,
                childAlignment);

            var image = groupObj.AddComponent<Image>();
            image.color = bgColor == default ? new Color(0.17f, 0.17f, 0.17f) : bgColor;

            return groupObj;
        }

        /// <summary>Create a HorizontalLayoutGroup object with an Image component. Use SetLayoutGroup to create one without an image.</summary>
        public static GameObject CreateHorizontalGroup(GameObject parent,
            string name,
            ...
            TextAnchor? childAlignment = null)
        {
            ...
            SetLayoutGroup<HorizontalLayoutGroup>(groupObj, forceExpandWidth, forceExpandHeight, childControlWidth, childControlHeight, spacing, (int)padding.x, (int)padding.y, (int)padding.z,
                (int)padding.w, childAlignment);
        ...
        /// <summary>Create a GridLayoutGroup object with an Image component.</summary>
        public static GameObject CreateGridGroup(GameObject parent,
            string name,
            Vector2 cellSize,
            Vector2 spacing,
            Color bgColor = default)
        {
            ...
            var gridGroup = groupObj.AddComponent<GridLayoutGroup>();
        ...
        /// <summary>Create a Text component.</summary>
        ...
        public static Text CreateLabel(GameObject parent,
            string name,
            string defaultText,
        ...
        /// <summary>Create a ButtonRef wrapper and a Button component, providing only the default Color (highlighted and pressed colors generated automatically).</summary>
        /// <param name="parent">The parent object to build onto</param>
        ...
        public static ButtonRef CreateButton(GameObject parent,
            string name,
            string text,
        ...
        /// <summary>Create a ButtonRef wrapper and a Button component.</summary>
        /// <param name="parent">The parent object to build onto</param>
        /// <param name="name">The GameObject name of your button</param>
        /// <param name="text">The default button text</param>
        ...
        /// <summary>Create a Slider control component.</summary>
        /// <param name="parent">The parent object to build onto</param>
            ...
            out Slider slider)
        {
            ...
            RuntimeHelper.Instance.Internal_SetColorBlock(slider, new Color(0.4f, 0.4f, 0.4f), new Color(0.55f, 0.55f, 0.55f), new Color(0.3f, 0.3f, 0.3f));

            return sliderObj;
        }

        /// <summary>Create a standard Unity Scrollbar component.</summary>
        /// <param name="parent">The parent object to build onto</param>
        ...
        {
            var scrollObj = CreateUIObject(name, parent, smallElementSize);

            var slideAreaObj = CreateUIObject("Sliding Area", scrollObj);
            var handleObj = CreateUIObject("Handle", slideAreaObj);
            ...
            var slideAreaRect = slideAreaObj.GetComponent<RectTransform>();
        ...
        /// <summary>Create a Toggle control component.</summary>
        /// <param name="parent">The parent object to build onto</param>
            ...
            int checkHeight = 20)
        {
            ...
            SetLayoutGroup<HorizontalLayoutGroup>(toggleObj, false, false, true, true, 5, 0, 0, 0, 0, TextAnchor.MiddleLeft);
            ...
            SetLayoutElement(checkBgObj, checkWidth, flexibleWidth: 0, minHeight: checkHeight, flexibleHeight: 0);
            ...
            var labelObj = CreateUIObject("Label", toggleObj);
            text = labelObj.AddComponent<Text>();
            text.text = "";
            text.alignment = TextAnchor.MiddleLeft;
            SetDefaultTextValues(text);

            SetLayoutElement(labelObj, 0, flexibleWidth: 0, minHeight: checkHeight, flexibleHeight: 0);
        ...
        /// <summary>Create a standard InputField control and an InputFieldRef wrapper for it.</summary>
        /// <param name="parent">The parent object to build onto</param>
        ...
        public static InputFieldRef CreateInputField(GameObject parent,
            string name,
            string placeHolderText)
        {
            var mainObj = CreateUIObject(name, parent);

            var mainImage = mainObj.AddComponent<Image>();
            ...
            RuntimeHelper.Instance.Internal_SetColorBlock(inputField, new Color(1, 1, 1, 1), new Color(0.95f, 0.95f, 0.95f, 1.0f), new Color(0.78f, 0.78f, 0.78f, 1.0f));
        ...
        /// <summary>Create a standard DropDown control.</summary>
        /// <param name="parent">The parent object to build onto</param>
        ...
        {
            var dropdownObj = CreateUIObject(name, parent, largeElementSize);

            var labelObj = CreateUIObject("Label", dropdownObj);
            var arrowObj = CreateUIObject("Arrow", dropdownObj);
            var templateObj = CreateUIObject("Template", dropdownObj);
            var viewportObj = CreateUIObject("Viewport", templateObj);
            var contentObj = CreateUIObject("Content", viewportObj);
            var itemObj = CreateUIObject("Item", contentObj);
            var itemBgObj = CreateUIObject("Item Background", itemObj);
            var itemCheckObj = CreateUIObject("Item Checkmark", itemObj);
            var itemLabelObj = CreateUIObject("Item Label", itemObj);

            var scrollbarObj = CreateScrollbar(templateObj, "DropdownScroll", out var scrollbar);
            ...
            var scrollRectTransform = scrollbarObj.GetComponent<RectTransform>();
            ...
            RuntimeHelper.Instance.Internal_SetColorBlock(itemToggle, new Color(0.35f, 0.35f, 0.35f, 1.0f), new Color(0.25f, 0.55f, 0.25f, 1.0f));
        ...
        /// <summary>Create a ScrollPool for the <typeparamref name="T" /> ICell. You should call scrollPool.Initialize(handler) after this.</summary>
        ...
        public static ScrollPool<T> CreateScrollPool<T>(GameObject parent,
            string name,
            out GameObject uiRoot,
            out GameObject content,
            Color? bgColor = null) where T : ICell
        {
            ...
            var viewportObj = CreateUIObject("Viewport", mainObj);
            ...
            viewportObj.AddComponent<Image>().color = new Color(0.1f, 0.1f, 0.1f, 1);
            ...
            var sliderContainer = CreateVerticalGroup(mainObj, "SliderContainer", false, false, true, true, 0, default, new Color(0.05f, 0.05f, 0.05f));
            SetLayoutElement(sliderContainer, 25, flexibleWidth: 0, flexibleHeight: 9999);
            sliderContainer.AddComponent<Mask>().showMaskGraphic = false;

            CreateSliderScrollbar(sliderContainer, out var slider);
        ...
        /// <summary>
        ///     Create a SliderScrollbar, using a Slider to mimic a Scrollbar. This fixes several issues with Unity's Scrollbar implementation.<br /><br /> Note that this will not have
        ///     any actual functionality. Use this along with an <see cref="AutoSliderScrollbar" /> to automate the functionality.
        /// </summary>
        ...
        public static GameObject CreateSliderScrollbar(GameObject parent,
            out Slider slider)
        {
            var mainObj = CreateUIObject("SliderScrollbar", parent, smallElementSize);
            mainObj.AddComponent<Mask>().showMaskGraphic = false;
            mainObj.AddComponent<Image>().color = new Color(0.1f, 0.1f, 0.1f, 1);

            var bgImageObj = CreateUIObject("Background", mainObj);
            var handleSlideAreaObj = CreateUIObject("Handle Slide Area", mainObj);
            var handleObj = CreateUIObject("Handle", handleSlideAreaObj);

            var bgImage = bgImageObj.AddComponent<Image>();
            bgImage.type = Image.Type.Sliced;
            bgImage.color = new Color(0.05f, 0.05f, 0.05f, 1.0f);

            bgImageObj.AddComponent<Mask>();

            var bgRect = bgImageObj.GetComponent<RectTransform>();
            ...
            SetLayoutElement(handleObj, 21, flexibleWidth: 0);
            ...
            SetLayoutElement(mainObj, 25, flexibleWidth: 0, flexibleHeight: 9999);

            RuntimeHelper.Instance.Internal_SetColorBlock(slider, new Color(0.4f, 0.4f, 0.4f), new Color(0.5f, 0.5f, 0.5f), new Color(0.3f, 0.3f, 0.3f), new Color(0.5f, 0.5f, 0.5f));

            return mainObj;
        }

        /// <summary>Create a ScrollView and a SliderScrollbar for non-pooled content.</summary>
            ...
            Color color = default)
        {
            ...
            var scrollBarObj = CreateUIObject("AutoSliderScrollbar", mainObj);
            ...
            scrollBarObj.AddComponent<Image>().color = new Color(0.1f, 0.1f, 0.1f, 1);
            scrollBarObj.AddComponent<Mask>().showMaskGraphic = false;

            var hiddenBar = CreateScrollbar(scrollBarObj, "HiddenScrollviewScroller", out var hiddenScrollbar);
            hiddenScrollbar.SetDirection(Scrollbar.Direction.BottomToTop, true);

            for (var i = 0; i < hiddenBar.transform.childCount; i++)
            {
                var child = hiddenBar.transform.GetChild(i);
                child.gameObject.SetActive(false);
            }

            CreateSliderScrollbar(scrollBarObj, out var scrollSlider);
        ...
        /// <summary>Create a Scrollable Input Field control, using an AutoSliderScrollbar for the scroll bar.</summary>
        /// <param name="parent">The parent GameObject to build on to.</param>
        ...
        public static GameObject CreateScrollInputField(GameObject parent,
            string name,
            string placeHolderText,
            ...
            Color color = default)
        {
            ...
            var mainObj = CreateUIObject(name, parent);
            SetLayoutElement(mainObj, 100, 30, 5000, 5000);
            ...
            var viewportObj = CreateUIObject("Viewport", mainObj);
            SetLayoutElement(viewportObj, 1, flexibleWidth: 9999, flexibleHeight: 9999);
            var viewportRect = viewportObj.GetComponent<RectTransform>();
            viewportRect.anchorMin = Vector2.zero;
            viewportRect.anchorMax = Vector2.one;
            viewportRect.pivot = new Vector2(0.0f, 1.0f);
            ...
            SetLayoutElement(scrollBarObj, 25, flexibleWidth: 0, flexibleHeight: 9999);
            scrollBarObj.AddComponent<Image>().color = new Color(0.1f, 0.1f, 0.1f, 1);
            scrollBarObj.AddComponent<Mask>().showMaskGraphic = false;
