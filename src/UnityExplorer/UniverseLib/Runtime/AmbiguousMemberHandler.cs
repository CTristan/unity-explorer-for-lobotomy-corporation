...
{
    /// <summary>Handles getting/setting arbitrary field/property members which may have different names or member types in different Unity versions.</summary>
    ...
    public class AmbiguousMemberHandler<TClass, TValue>
    {
        ...
        public AmbiguousMemberHandler(bool canWrite,
            bool canRead,
            params string[] possibleNames)
        {
            foreach (var name in possibleNames)
            {
                if (typeof(TClass).GetProperty(name, AccessTools.all) is PropertyInfo pi && typeof(TValue).IsAssignableFrom(pi.PropertyType) && (!canWrite || pi.CanWrite) && (!canRead || pi.CanRead))
                {
                    member = pi;
        ...
        /// <summary>Gets the value of an instance member from the provided instance.</summary>
        ...
        {
            return DoGetValue(instance);
        }

        /// <summary>Gets the value of a static member.</summary>
        /// <returns>The value from the member, if successful.</returns>
        ...
        /// <summary>Sets the value of an instance member to the instance.</summary>
        ...
        /// <summary>Sets the value of a static member.</summary>
        /// <param name="value">The value to set to the instance.</param>
        ...
        private void DoSetValue(object instance,
            TValue value)
        {
            if (member == null)
            {
