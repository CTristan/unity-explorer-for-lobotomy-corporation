...
namespace UnityExplorerForLobotomyCorporation.UnityExplorer.ObjectExplorer
{
    public class ObjectSearch : UIModel
    {
        ...
        {
            sceneFilter = (SceneFilter)value;
        }

        private void OnChildFilterDropChanged(int value)
        {
            childFilter = (ChildFilter)value;
        }
        ...
        private bool ShouldDisplayCell(object arg1,
            string arg2)
        {
            return true;
        }
        ...
        public override void ConstructUI(GameObject parent)
        {
            ...
            var contextLbl = UIFactory.CreateLabel(contextGroup, "SearchContextLabel", "Searching for:");
            UIFactory.SetLayoutElement(contextLbl.gameObject, 110, flexibleWidth: 0);

            var contextDropObj = UIFactory.CreateDropdown(contextGroup, "ContextDropdown", out var contextDrop, null, 14, OnContextDropdownChanged);
            ...
            var unityClassLbl = UIFactory.CreateLabel(classInputRow, "ClassLabel", "Class filter:");
            UIFactory.SetLayoutElement(unityClassLbl.gameObject, 110, flexibleWidth: 0);
            ...
            unityObjectTypeCompleter = new TypeCompleter(typeof(Object), classInputField, true, false, true);
            allTypesCompleter = new TypeCompleter(null, classInputField, true, false, true);
            allTypesCompleter.Enabled = false;
            ...
            var childLbl = UIFactory.CreateLabel(childFilterRow, "ChildLabel", "Child filter:");
            UIFactory.SetLayoutElement(childLbl.gameObject, 110, flexibleWidth: 0);

            var childDropObj = UIFactory.CreateDropdown(childFilterRow, "ChildFilterDropdown", out var childDrop, null, 14, OnChildFilterDropChanged);
            ...
            var sceneLbl = UIFactory.CreateLabel(sceneFilterRow, "SceneLabel", "Scene filter:");
            UIFactory.SetLayoutElement(sceneLbl.gameObject, 110, flexibleWidth: 0);

            var sceneDropObj = UIFactory.CreateDropdown(sceneFilterRow, "SceneFilterDropdown", out var sceneDrop, null, 14, OnSceneFilterDropChanged);
            ...
            var nameLbl = UIFactory.CreateLabel(nameInputRow, "NameFilterLabel", "Name contains:");
            UIFactory.SetLayoutElement(nameLbl.gameObject, 110, flexibleWidth: 0);
            ...
            resultsScrollPool = UIFactory.CreateScrollPool<ButtonCell>(uiRoot, "ResultsList", out var scrollObj, out var scrollContent);
