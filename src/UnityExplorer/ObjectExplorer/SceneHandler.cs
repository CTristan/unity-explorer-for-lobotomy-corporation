...
namespace UnityExplorerForLobotomyCorporation.UnityExplorer.ObjectExplorer
{
    public static class SceneHandler
    {
        ...
        public static List<Scene> LoadedScenes { get; } = new List<Scene>();
        ...
        internal static void Init()
        {
            ...
            try
            {
                var sceneUtil = ReflectionUtility.GetTypeByName("UnityEngine.SceneManagement.SceneUtility");
                if (sceneUtil == null)
                {
                ...
                {
                    var scenePath = (string)method.Invoke(null, new object[]
                    {
                        i,
                    });
        ...
        internal static void Update()
        {
            ...
            var inspectedExists = SelectedScene.HasValue && ((DontDestroyExists && SelectedScene.Value.handle == -12) || SelectedScene.Value.handle == -1);
