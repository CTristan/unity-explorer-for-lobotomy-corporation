...
namespace UnityExplorerForLobotomyCorporation.UnityExplorer.Inspectors.MouseInspectors
{
    public class UiInspector : MouseInspectorBase
    {
        ...
        private static void SetupUIRaycast()
        {
            ...
            for (var i = 0; i < casters.Length; i++) graphicRaycasters[i] = casters[i].TryCast<GraphicRaycaster>();
