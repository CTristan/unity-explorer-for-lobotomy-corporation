...
namespace UnityExplorerForLobotomyCorporation.UnityExplorer.UI.Widgets.UnityObjects
{
    public class AudioClipWidget : UnityObjectWidget
    {
        ...
        {
            progressLabel.text = $"{zeroLengthString} / {fullLengthText}";
        }
        ...
        private static void SetupAudioPlayer()
        {
            ...
            AudioPlayerObject.transform.position = new Vector3(int.MinValue, int.MinValue); // move it as far away as possible
        ...
        public override GameObject CreateContent(GameObject uiRoot)
        {
            ...
            audioPlayerRoot = UIFactory.CreateVerticalGroup(uiRoot, "AudioWidget", false, false, true, true, 5);
            UIFactory.SetLayoutElement(audioPlayerRoot, flexibleWidth: 9999, flexibleHeight: 50);
            audioPlayerRoot.SetActive(false);

            // Player

            var playerRow = UIFactory.CreateHorizontalGroup(audioPlayerRoot, "PlayerWidget", false, false, true, true, 5, new Vector4
            {
                x = 3f,
                w = 3f,
                y = 3f,
            ...
            playStopButton = UIFactory.CreateButton(playerRow, "PlayerButton", "Play", new Color(0.2f, 0.4f, 0.2f));
            playStopButton.OnClick += OnPlayStopClicked;
            UIFactory.SetLayoutElement(playStopButton.GameObject, 60, 25);
            ...
            saveObjectRow = UIFactory.CreateHorizontalGroup(audioPlayerRoot, "SaveRow", false, false, true, true, 2, new Vector4(2, 2, 2, 2), new Color(0.1f, 0.1f, 0.1f));

            var saveBtn = UIFactory.CreateButton(saveObjectRow, "SaveButton", "Save .WAV", new Color(0.2f, 0.25f, 0.2f));
            ...
            UIFactory.CreateLabel(cantSaveRow, "CantSaveLabel", "Cannot save this AudioClip as the data is compressed or streamed. Try a tool such as AssetRipper to unpack it.", color: Color.grey);
    ...
    public static class SavWav
    {
        ...
        public static void Save(AudioClip clip,
            string filepath)
        {
        ...
        private static void ConvertAndWrite(FileStream fileStream,
            AudioClip clip)
        {
#if CPP
