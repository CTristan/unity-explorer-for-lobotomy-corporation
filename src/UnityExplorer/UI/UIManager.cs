...
using UnityExplorerForLobotomyCorporation.UnityExplorer.UI.Widgets;
...
namespace UnityExplorerForLobotomyCorporation.UnityExplorer.UI
{
    public static class UIManager
    {
        ...
        public static void SetPanelActive(Panels panelType,
            bool active)
        {
            GetPanel(panelType).SetActive(active);
        }

        public static void SetPanelActive(UEPanel panel,
            bool active)
        {
        ...
        private static void CreateTopNavBar()
        {
            ...
            SetNavBarAnchor();
            ConfigManager.Main_Navbar_Anchor.OnValueChanged += val =>
            {
                NavbarAnchor = val;
                SetNavBarAnchor();
            };
            ...
            var titleTxt = $"UE <i><color=grey>{ExplorerCore.VERSION}</color></i>";
            var title = UIFactory.CreateLabel(navbarPanel, "Title", titleTxt, TextAnchor.MiddleCenter);
            UIFactory.SetLayoutElement(title.gameObject, 75, flexibleWidth: 0);
            ...
            // Time scale widget
            timeScaleWidget = new TimeScaleWidget(navbarPanel);
            ...
            RuntimeHelper.SetColorBlock(closeBtn.Component, new Color(0.63f, 0.32f, 0.31f), new Color(0.81f, 0.25f, 0.2f), new Color(0.6f, 0.18f, 0.16f));
